...
python main.py --config configs/cfg_V1.yml --data_path ../../../datasets/private/METABREST/T1W_Breast/video_data --exp mcvd_V1 --ni --config_mod sampling.max_data_iter=1000 sampling.num_frames_pred=29 sampling.preds_per_test=10 sampling.subsample=100 model.version=DDPM --ckpt 105000 --video_gen -v mcvd_V1_100k
