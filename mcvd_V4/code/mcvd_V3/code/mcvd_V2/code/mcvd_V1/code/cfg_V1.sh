...
#SBATCH --output=../MetaBreast/logs/mcvd/V1/output.out           # Filename with STDOUT. You can use special flags, such as %N and %j.
#SBATCH --error=../MetaBreast/logs/mcvd/V1/error.out             # (Optional) Filename with STDERR. If ommited, use STDOUT.
